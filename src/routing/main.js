...
import { contacted } from '../pages/keywordsPages';
...
for (let i=0; i<keywordsCompsList.length; i++) {
    pushedRoutes.push(<Route key={fixedKwEncoded[i]} path={fixedKwEncoded[i]} element={React.createElement(keywordsComponents[contacted[i]])} />)    
}
